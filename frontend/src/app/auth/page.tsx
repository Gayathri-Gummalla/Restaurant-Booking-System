...
export default function AuthPage() {
    ...
    const handleSocialLogin = async (provider: string) => {
        setLoading(true);
        try {
            // Simulate API delay for social login
            ...
            addToast('success', `Signed in with ${provider}!`, 'Welcome to Spice Garden.');
            ...
            addToast('error', `${provider} Sign In Failed`, 'Please try again later.');
        } finally {
            setLoading(false);
        }
    };
